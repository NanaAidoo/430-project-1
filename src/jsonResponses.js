...
// gets the data from from client and based on what data is sent adds the data to
// the user's array in the server and sends the appropriate post code
const addUser = (request, response, body) => {
  ...
  if (!body.monday && !body.tuesday && !body.wednesday
